...
import br.com.devLearn.application.controller.mappers.category.CategoryStoreMapper
...
class CategoryController(
    ...
    private val storeMapper: CategoryStoreMapper
) {
    ...
    @PostMapping
    fun saveCourse(@RequestBody @Valid dto: CategoryStoreDto,
